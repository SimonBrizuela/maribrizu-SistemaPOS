...
const PANTALLAS = [
  ...
  ['Reclamos de la Tienda', () => import('../../webapp/src/pages/tienda_reclamos.js'), 'renderTiendaReclamos'],
...
const CON_DATOS = {
  ...
  tienda_reclamos: [{ __id: 'k1-1', id: 'k1-1', pedido_id: 'k1', pedido_codigo: 'K7M2', estado: 'nuevo',
                      motivo: 'roto', detalle: 'Llegó mojado.', creado: new Date(),
                      cliente: { nombre: 'Marta', telefono: '3515550001' }, entrega_modo: 'retiro',
                      productos: [{ renglon: 0, id: 'p1', nombre: 'Cuaderno', cantidad: 1 }], fotos: [] }],
