  ...
  },
  {
    ...
    pistas: {
      ...
      palabras: ['cuaderno', 'carpeta', 'repuesto', 'mochila', 'cartuchera', 'lapiz', 'lápiz',
        'boligrafo', 'bolígrafo', 'regla', 'compas', 'compás', 'tijera', 'plasticola',
        'forro', 'etiqueta', 'block', 'folio', 'resma', 'marcador', 'cartulina', 'tempera', 'témpera',
        'goma de borrar', 'sacapunta', 'agenda'],
      colores: [],
    },
