...
class MainWindow(QMainWindow):
    ...
    # La sincronización con Google Sheets se dio de baja: la planilla dejó
    # de usarse y el webhook nunca se llegaba a inicializar (`init_sync()`
    # no lo llamaba nadie), así que el sync no hacía nada — pero el cartel
    # de "Sincronizando con Google Sheets..." saltaba igual cada 40 minutos
    # arriba de lo que estuviera haciendo la persona en la caja.
    # El botón "Sincronizar" de la barra es el de Firebase y sigue igual.
